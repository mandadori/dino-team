...
- **Tarefa:** descrição específica (ex: "produza N slides visuais a partir do copy em `<path>`, um por bloco").
- **Inputs:**
...
- **Saída:** pasta destino e padrão de nome dos arquivos (ex: `<pasta>/design/slide-N.html`).
